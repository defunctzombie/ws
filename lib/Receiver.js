...
Receiver.prototype.processPacket = function (data) {
  ...
  // for some reason the above code does not properly look up handler
  // when run on tessel
  // seems to be an issue with using a hard coded string versus a runtime string
  // even String(this.state.opcode) doesn't work
